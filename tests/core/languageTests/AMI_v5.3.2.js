...
//
//var testSuite = 'LANGUAGETESTS_AMI_v5.3.2';
//var testSuiteDesc = 'Github Organization language tests for AMI v5.3.2';
...
//                  _.where(projects, {isOrg: true, fullName: 'ami-v5-3-2/u16all'}
//                  )
//                );
//                var u16cloallProject = _.first(
//                  _.where(projects, {isOrg: true, fullName: 'ami-v5-3-2/u16cloall'}
//                  )
//                );
//                var u16cppallProject = _.first(
//                  _.where(projects, {isOrg: true, fullName: 'ami-v5-3-2/u16cppall'}
//                  )
//                );
//                var u16golallProject = _.first(
//                  _.where(projects, {isOrg: true, fullName: 'ami-v5-3-2/u16golall'}
//                  )
//                );
//                var u16javallProject = _.first(
//                  _.where(projects, {isOrg: true, fullName: 'ami-v5-3-2/u16javall'}
//                  )
//                );
//                var u16nodallProject = _.first(
//                  _.where(projects, {isOrg: true, fullName: 'ami-v5-3-2/u16nodall'}
//                  )
//                );
//                var u16phpallProject = _.first(
//                  _.where(projects, {isOrg: true, fullName: 'ami-v5-3-2/u16phpall'}
//                  )
//                );
//                var u16pytallProject = _.first(
//                  _.where(projects, {isOrg: true, fullName: 'ami-v5-3-2/u16pytall'}
//                  )
//                );
//                var u16ruballProject = _.first(
//                  _.where(projects, {isOrg: true, fullName: 'ami-v5-3-2/u16ruball'}
//                  )
//                );
//                var u16scaallProject = _.first(
//                  _.where(projects, {isOrg: true, fullName: 'ami-v5-3-2/u16scaall'}
//                  )
//                );
//                var u16Project = _.first(
//                  _.where(projects, {isOrg: true, fullName: 'ami-v5-3-2/u16'}
//                  )
//                );
...
//      function (done) {
//        var runId = _.findWhere(runs, {projectName: 'u16', subscriptionOrgName: 'ami-v5-3-2'}).id;
...
//      function (done) {
//        var runId = _.findWhere(runs, {projectName: 'u16cppall', subscriptionOrgName: 'ami-v5-3-2'}).id;
//        global.getRunByIdStatusWithBackOff(amiApiAdapter, runId,
//          successStatusCode, done);
//      },
//      function(err) {
...
//      function (done) {
//        var runId = _.findWhere(runs, {projectName: 'u16phpall', subscriptionOrgName: 'ami-v5-3-2'}).id;
//        global.getRunByIdStatusWithBackOff(amiApiAdapter, runId,
//          successStatusCode, done);
//      },
//      function(err) {
...
//      function (done) {
//        var runId = _.findWhere(runs, {projectName: 'u16golall', subscriptionOrgName: 'ami-v5-3-2'}).id;
//        global.getRunByIdStatusWithBackOff(amiApiAdapter, runId,
//          successStatusCode, done);
//      },
//      function(err) {
...
//      function (done) {
//        var runId = _.findWhere(runs, {projectName: 'u16scaall', subscriptionOrgName: 'ami-v5-3-2'}).id;
//        global.getRunByIdStatusWithBackOff(amiApiAdapter, runId,
//          successStatusCode, done);
//      },
//      function(err) {
...
//      function (done) {
//        var runId = _.findWhere(runs, {projectName: 'u16javall', subscriptionOrgName: 'ami-v5-3-2'}).id;
//        global.getRunByIdStatusWithBackOff(amiApiAdapter, runId,
//          successStatusCode, done);
//      },
//      function(err) {
...
//      function (done) {
//        var runId = _.findWhere(runs, {projectName: 'u16cloall', subscriptionOrgName: 'ami-v5-3-2'}).id;
//        global.getRunByIdStatusWithBackOff(amiApiAdapter, runId,
//          successStatusCode, done);
//      },
//      function(err) {
...
//      function (done) {
//        var runId = _.findWhere(runs, {projectName: 'u16nodall', subscriptionOrgName: 'ami-v5-3-2'}).id;
//        global.getRunByIdStatusWithBackOff(amiApiAdapter, runId,
//          successStatusCode, done);
//      },
//      function(err) {
...
//      function (done) {
//        var runId = _.findWhere(runs, {projectName: 'u16pytall', subscriptionOrgName: 'ami-v5-3-2'}).id;
//        global.getRunByIdStatusWithBackOff(amiApiAdapter, runId,
//          successStatusCode, done);
//      },
//      function(err) {
...
//      function (done) {
//        var runId = _.findWhere(runs, {projectName: 'u16all', subscriptionOrgName: 'ami-v5-3-2'}).id;
//        global.getRunByIdStatusWithBackOff(amiApiAdapter, runId,
//          successStatusCode, done);
//      },
//      function(err) {
...
//      function (done) {
//        var runId = _.findWhere(runs, {projectName: 'u16ruball', subscriptionOrgName: 'ami-v5-3-2'}).id;
//        global.getRunByIdStatusWithBackOff(amiApiAdapter, runId,
//          successStatusCode, done);
//      },
//      function(err) {
